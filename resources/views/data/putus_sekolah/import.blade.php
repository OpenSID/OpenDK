    ...
    <section class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                {!! Form::open([
                    'route' => 'data.putus-sekolah.do_import',
                    'method' => 'post',
                    'id' => 'form-import',
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-3 col-xs-12" for="data_file">Data Putus
                                    Sekolah</label>
                        ...
                        <div class="col-md-6">
                            <div class="well">
                                ...
                                <p>Silakan download template upload data di sini: <a href="{{ asset('storage/template_upload/Format_Upload_Putus_Sekolah.xlsx') }}">Download</a>
                                </p>
                            </div>
                        </div>
                    </div>
