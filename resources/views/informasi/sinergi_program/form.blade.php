...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <img src="@if (isset($sinergi->gambar)) {{ asset($sinergi->gambar) }} @else {{ 'http://placehold.co/1000x600' }} @endif" id="showgambar" style="max-width:400px;max-height:250px;float:left;" />
