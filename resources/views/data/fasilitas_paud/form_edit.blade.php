<div class="form-group">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        {!! Html::number('jumlah_paud', null, ['class' => 'form-control', 'required' => true, 'id' => 'jumlah_paud'])
        !!}
    </div>
</div>
<div class="form-group">
    <label for="jumlah_guru_paud" class="control-label col-md-4 col-sm-3 col-xs-12">Jumlah Guru PAUD <span
            class="required">*</span></label>
    <div class="col-md-3 col-sm-6 col-xs-12">
        {!! Html::number('jumlah_guru_paud', null, ['class' => 'form-control', 'required' => true, 'id' =>
        'jumlah_guru_paud']) !!}
    </div>
</div>
<div class="form-group">
    <label for="jumlah_siswa_paud" class="control-label col-md-4 col-sm-3 col-xs-12">Jumlah Siswa PAUD <span
            class="required">*</span></label>
    <div class="col-md-3 col-sm-6 col-xs-12">
        {!! Html::number('jumlah_siswa_paud', null, ['class' => 'form-control', 'required' => true, 'id' =>
        'jumlah_siswa_paud']) !!}
    </div>
</div>
<div class="form-group">
