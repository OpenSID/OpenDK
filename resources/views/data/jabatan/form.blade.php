<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::text('nama', null, ['placeholder' => 'Nama Jabatan', 'class' => 'form-control', 'required' => true])
        !!}
        {{ Html::hidden('jenis') }}
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::textarea('tupoksi', null, ['class' => 'textarea', 'placeholder' => 'Tupoksi', 'style' => 'width: 100%;
