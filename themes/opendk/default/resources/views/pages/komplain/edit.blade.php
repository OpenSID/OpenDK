...
<div class="col-md-8 col-sm-8 col-xs-12">
    {!! Html::textarea('laporan', old('laporan',
    $komplain->laporan))->placeholder('Laporan')->class('form-control')->rows(4)->required() !!}
...
<div class="col-md-4 col-sm-4 col-xs-12">
    {!! Html::text('judul', old('judul', $komplain->judul))->placeholder('Judul')->class('form-control')->required() !!}
    @if ($errors->has('judul'))
    <span class="help-block">
...
<section class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <!-- kirim komplain form -->
            {!! Html::form('PUT', route('sistem-komplain.update',
            $komplain->id))->model($komplain)->id('form-komplain')->class('form-horizontal
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('nik') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    {!! Html::text('nik', old('nik',
                                    $komplain->nik))->placeholder('NIK')->class('form-control')->required()->readonly()
                                    !!}
                                    @if ($errors->has('nik'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    $komplain->nama))->placeholder('Nama')->class('form-control')->required()->readonly()
                                    !!}
                                    @if ($errors->has('nama'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    old('kategori',
                                    $komplain->kategori_id))->class('form-control')->id('kategori')->required() !!}
                            ...
                            <div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    {!! Html::text('judul', old('judul',
                                    $komplain->judul))->placeholder('Judul')->class('form-control')->required() !!}
                                    @if ($errors->has('judul'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('judul') }}</strong>
                                    </span>
                            ...
                            <div class="form-group{{ $errors->has('laporan') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    {!! Html::textarea('laporan', old('laporan',
                                    $komplain->laporan))->placeholder('Laporan')->class('form-control')->required() !!}
                                    @if ($errors->has('laporan'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('laporan') }}</strong>
                                    </span>
                            ...
                            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    'Selesai'],
                                    old('status', $komplain->status))->class('form-control') !!}
