<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->text('nama')
        ->value(old('nama', isset($sinergi) ? $sinergi->nama : ''))
        ->placeholder('Nama')
        ->class('form-control')
        ->required() !!}
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->text('url')
        ->value(old('url', isset($sinergi) ? $sinergi->url : ''))
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ->class('form-control')
        ->attributes($sinergi ? [] : ['required']) !!}
        <br>
        <img src="{{ isset($sinergi->gambar) ? asset($sinergi->gambar) : 'http://placehold.co/1000x600' }}"
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ->value(old('status', isset($sinergi) ? $sinergi->status : ''))
        ->class('form-control') !!}
    </div>
</div>
