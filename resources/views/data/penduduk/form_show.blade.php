<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('nama')->value(old('nama', isset($penduduk)->value(old('nama', isset($penduduk) ?
                $penduduk->nama : '')) ? $penduduk->nama : ''))->class('form-control')->id('nama') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('nik')->value(old('nik', isset($penduduk)->value(old('nik', isset($penduduk) ?
                $penduduk->nik : '')) ? $penduduk->nik : ''))->class('form-control')->id('nik') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('no_kk_sebelumnya')->value(old('no_kk_sebelumnya',
                isset($penduduk)->value(old('no_kk_sebelumnya', isset($penduduk) ? $penduduk->no_kk_sebelumnya : '')) ?
                $penduduk->no_kk_sebelumnya : ''))->class('form-control')->id('no_kk_sebelumnya') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('kk_level', \App\Models\HubunganKeluarga::pluck('nama', 'id')->value(old('kk_level',
                isset($penduduk)->value(old('kk_level', isset($penduduk) ? $penduduk->kk_level : '')) ?
                $penduduk->kk_level : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('agama_id', \App\Models\Agama::pluck('nama', 'id')->value(old('agama_id',
                isset($penduduk)->value(old('agama_id', isset($penduduk) ? $penduduk->agama_id : '')) ?
                $penduduk->agama_id : '')), null, ['class' => 'form-control',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('akta_lahir')->value(old('akta_lahir', isset($penduduk)->value(old('akta_lahir',
                isset($penduduk) ? $penduduk->akta_lahir : '')) ? $penduduk->akta_lahir :
                ''))->class('form-control')->id('akta_lahir') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('tempat_lahir')->value(old('tempat_lahir', isset($penduduk)->value(old('tempat_lahir',
                isset($penduduk) ? $penduduk->tempat_lahir : '')) ? $penduduk->tempat_lahir :
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('wajib_ktp')->value(old('wajib_ktp', isset($penduduk)->value(old('wajib_ktp',
                isset($penduduk) ? $penduduk->wajib_ktp : '')) ? $penduduk->wajib_ktp :
                ''))->class('form-control')->id('wajib_ktp')
                !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('status_rekam', status_rekam()->value(old('status_rekam',
                isset($penduduk)->value(old('status_rekam', isset($penduduk) ? $penduduk->status_rekam : '')) ?
                $penduduk->status_rekam : '')), null, ['class' => 'form-control', 'disabled', 'id' =>
                'status_rekam']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('pendidikan_kk_id', \App\Models\PendidikanKK::pluck('nama',
                'id')->value(old('pendidikan_kk_id', isset($penduduk)->value(old('pendidikan_kk_id', isset($penduduk) ?
                $penduduk->pendidikan_kk_id : '')) ? $penduduk->pendidikan_kk_id : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('pendidikan_sedang_id', \App\Models\Pendidikan::pluck('nama',
                'id')->value(old('pendidikan_sedang_id', isset($penduduk)->value(old('pendidikan_sedang_id',
                isset($penduduk) ? $penduduk->pendidikan_sedang_id : '')) ? $penduduk->pendidikan_sedang_id : '')),
                null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('pekerjaan_id', \App\Models\Pekerjaan::pluck('nama', 'id')->value(old('pekerjaan_id',
                isset($penduduk)->value(old('pekerjaan_id', isset($penduduk) ? $penduduk->pekerjaan_id : '')) ?
                $penduduk->pekerjaan_id : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('warga_negara_id', \App\Models\Warganegara::pluck('nama',
                'id')->value(old('warga_negara_id', isset($penduduk)->value(old('warga_negara_id', isset($penduduk) ?
                $penduduk->warga_negara_id : '')) ? $penduduk->warga_negara_id : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('dokumen_pasport')->value(old('dokumen_pasport',
                isset($penduduk)->value(old('dokumen_pasport', isset($penduduk) ? $penduduk->dokumen_pasport : '')) ?
                $penduduk->dokumen_pasport : ''))->class('form-control')->id('dokumen_pasport') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('dokumen_kitas')->value(old('dokumen_kitas',
                isset($penduduk)->value(old('dokumen_kitas', isset($penduduk) ? $penduduk->dokumen_kitas : '')) ?
                $penduduk->dokumen_kitas : ''))->class('form-control')->id('dokumen_kitas')
                !!}
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('ayah_nik')->value(old('ayah_nik', isset($penduduk)->value(old('ayah_nik',
                isset($penduduk) ? $penduduk->ayah_nik : '')) ? $penduduk->ayah_nik :
                ''))->class('form-control')->id('ayah_nik') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('nama_ayah')->value(old('nama_ayah', isset($penduduk)->value(old('nama_ayah',
                isset($penduduk) ? $penduduk->nama_ayah : '')) ? $penduduk->nama_ayah :
                ''))->class('form-control')->id('nama_ayah') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('ibu_nik')->value(old('ibu_nik', isset($penduduk)->value(old('ibu_nik',
                isset($penduduk) ? $penduduk->ibu_nik : '')) ? $penduduk->ibu_nik :
                ''))->class('form-control')->id('ibu_nik') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('nama_ibu')->value(old('nama_ibu', isset($penduduk)->value(old('nama_ibu',
                isset($penduduk) ? $penduduk->nama_ibu : '')) ? $penduduk->nama_ibu :
                ''))->class('form-control')->id('nama_ibu') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('telepon')->value(old('telepon', isset($penduduk)->value(old('telepon',
                isset($penduduk) ? $penduduk->telepon : '')) ? $penduduk->telepon :
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('alamat_sebelumnya')->value(old('alamat_sebelumnya',
                isset($penduduk)->value(old('alamat_sebelumnya', isset($penduduk) ? $penduduk->alamat_sebelumnya : ''))
                ? $penduduk->alamat_sebelumnya : ''))->class('form-control')->id('alamat_sebelumnya') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('alamat')->value(old('alamat', isset($penduduk)->value(old('alamat', isset($penduduk) ?
                $penduduk->alamat : '')) ? $penduduk->alamat : ''))->class('form-control')->id('alamat_s') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('status_kawin', \App\Models\Kawin::pluck('nama', 'id')->value(old('status_kawin',
                isset($penduduk)->value(old('status_kawin', isset($penduduk) ? $penduduk->status_kawin : '')) ?
                $penduduk->status_kawin : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('akta_perkawinan')->value(old('akta_perkawinan',
                isset($penduduk)->value(old('akta_perkawinan', isset($penduduk) ? $penduduk->akta_perkawinan : '')) ?
                $penduduk->akta_perkawinan : ''))->class('form-control')->id('akta_perkawinan') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->text('akta_perceraian')->value(old('akta_perceraian',
                isset($penduduk)->value(old('akta_perceraian', isset($penduduk) ? $penduduk->akta_perceraian : '')) ?
                $penduduk->akta_perceraian : ''))->class('form-control')->id('akta_perceraian') !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('golongan_darah_id', \App\Models\GolonganDarah::pluck('nama',
                'id')->value(old('golongan_darah_id', isset($penduduk)->value(old('golongan_darah_id', isset($penduduk)
                ? $penduduk->golongan_darah_id : '')) ? $penduduk->golongan_darah_id : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('cacat_id', \App\Models\Cacat::pluck('nama', 'id')->value(old('cacat_id',
                isset($penduduk)->value(old('cacat_id', isset($penduduk) ? $penduduk->cacat_id : '')) ?
                $penduduk->cacat_id : '')), null, ['class' => 'form-control',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('sakit_menahun_id', \App\Models\SakitMenahun::pluck('nama',
                'id')->value(old('sakit_menahun_id', isset($penduduk)->value(old('sakit_menahun_id', isset($penduduk) ?
                $penduduk->sakit_menahun_id : '')) ? $penduduk->sakit_menahun_id : '')), null, ['class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! html()->select('cara_kb_id', \App\Models\CaraKB::pluck('nama', 'id')->value(old('cara_kb_id',
                isset($penduduk)->value(old('cara_kb_id', isset($penduduk) ? $penduduk->cara_kb_id : '')) ?
                $penduduk->cara_kb_id : '')), null, ['class' =>
