...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div style="display: flex; flex-direction: column;">
            ...
            'Pilih Nama Anggota', 'disabled', 'style' => 'width:100%;']) !!}
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::number('no_anggota', null, ['placeholder' => 'Nomor Anggota', 'class' => 'form-control', 'required' =>
        true, 'min' => 1]) !!}
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::text('no_sk_jabatan', null, ['placeholder' => 'Nomor SK Jabatan', 'class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::text('no_sk_pengangkatan', null, ['placeholder' => 'Nomor SK Pengangkatan', 'class' =>
        'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::text('no_sk_pemberhentian', null, ['placeholder' => 'Nomor SK Pemberhentian', 'class' =>
        'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::text('periode', null, ['placeholder' => 'Contoh: 6 Tahun Periode Pertama (2015 s/d 2021)', 'class' =>
        'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Html::textarea('keterangan', null, ['placeholder' => 'Keterangan', 'class' => 'form-control', 'rows' => 2])
        !!}
    </div>
</div>
