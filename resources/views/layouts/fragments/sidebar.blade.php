...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ Request::is(['pesan*']) ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li {{ Request::is(['pesan/keluar']) ? 'class=active' : '' }}><a
                            ...
                            Keluar</a></li>
                    <li {{ Request::is(['pesan/arsip']) ? 'class=active' : '' }}><a href="{{ route('pesan.arsip') }}"><i
                                class="fa fa-archive"></i>Arsip</a></li>
                </ul>
            </li>
            @endif
            ...
            <li class="treeview {{ Request::is(['surat*']) ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li {{ Request::is(['surat/permohonan*']) ? 'class=active' : '' }}><a
                            href="{{ route('surat.permohonan') }}"><i class="fa fa-files-o"></i>Permohonan</a></li>
            ...
            <li class="treeview {{ Request::is(['setting*', 'otp/activate*', '2fa/*']) ? 'active' : '' }}"><a
                ...
                <ul class="treeview-menu">
                    ...
                    <li {{ Request::is(['setting/themes*']) ? 'class=active' : '' }}><a
                            href="{{ route('setting.themes.index') }}"><i class="fa fa-circle-o"></i>Themes</a></li>
                    @endif
                    @if ($user->hasrole(['super-admin', 'administrator-website']))
