                    ...
                    <div class="post">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>Yth: {{ config('profil.sebutan_kepala_wilayah') . ' ' .
                                    config('profil.nama_kecamatan') }}</p>
                                <br>
                                <p>
                                    {{ $komplain->laporan }}
                                </p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @if ($komplain->lampiran1 == '' && $komplain->lampiran2 == '' && $komplain->lampiran3 ==
                                '' && $komplain->lampiran4 == '')
                                <p>
                                    Tidak ada lampiran.
                                </p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Html::hidden('komplain_id', $komplain->komplain_id)->id('komplain_id') !!}
                                <div id="jawabans"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="user-block">
                        ...
                        <img class="img-circle img-bordered-sm"
                            src="{{ is_user(json_decode($komplain->detail_penduduk)->foto, json_decode($komplain->detail_penduduk)->sex) }}"
                            alt="user image">
                        @else

                        {{-- diambil dari relasi penduduk --}}
                        <img class="img-circle img-bordered-sm"
                            src="{{ is_user($komplain?->penduduk?->foto, $komplain?->penduduk?->sex) }}"
                            alt="user image">
                        @endif
                        ...
                        <span class="description">PELAPOR : {{ auth()->guest() && $komplain->anonim ? 'ANONIM' :
                            $komplain->nama }}</span>
                    </div>
                    <!-- /.user-block -->
                    <br>
                    ...
                    <div class="pull-right">
                        <div class="control-group">
                            ...
                            @else
                            @if ($komplain->status != 'SELESAI')
                            <a id="btn-reply" data-href="{{ route('sistem-komplain.reply', $komplain->komplain_id) }}"
                                class="btn btn-sm btn-primary"><i class="fa fa-reply"></i> Beri Komentar</a>
                            @endif
                            @endif
...
<div id="modalReply" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Html::form('POST')->id('form-reply')->open() !!}
            <div class="modal-body mx-3">
                <div id="form-errors"></div>
                <div class="md-form mb-4">
                    <label>Jawaban</label>
                    @csrf
                    {!! Html::textarea('jawaban')->class('form-control')->id('jawab')->required() !!}
                </div>
                ...
                <div class="md-form mb-4{{ $errors->has('nik') ? ' has-error' : '' }}">
                    ...
                    {!! Html::text('nik')->placeholder('NIK')->class('form-control')->required()->id('nik') !!}
                    @if ($errors->has('nik'))
                ...
                <div class="md-form mb-4{{ $errors->has('tanggal_lahir') ? ' has-error' : '' }}">
                    ...
                    {!! Html::text('tanggal_lahir')->placeholder('1990-01-01')->class('form-control
                    datepicker')->required()->id('tanggal_lahir') !!}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <label>Jawaban</label>
                    {!! Html::textarea('jawaban')->class('form-control')->id('jawab-admin')->required() !!}
                    {!! Html::hidden('nik', '999') !!}
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <label>Jawaban</label>
                    {!! Html::textarea('jawaban')->class('form-control')->id('ubah-jawab-admin')->required() !!}
                    {!! Html::hidden('nik', '999') !!}
