...
.btn-dark:active:hover, .btn-dark.active:hover, .open > .dropdown-toggle.btn-dark:hover {
    color: #fff;
        ...
        <div class="col-md-5">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    {!! Form::button('<i class="fa fa-save"></i> Simpan', ['type' => 'button', 'class' => 'btn btn-primary btn-sm',
                    'id' => 'btnUpdate'] ) !!}
                    {!! Form::button('<i class="fa fa-plus-square"></i> Tambah', ['type' => 'button', 'class' => 'btn btn-success
                    btn-sm', 'id' => 'btnAdd'] ) !!}
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                            {!! Form::button('<i class="fa fa-times"></i> Batal', ['type' => 'button', 'class' => 'btn btn-danger btn-sm
                            reload'] ) !!}
