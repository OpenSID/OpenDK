            ...
            <div>
                ...
                <div class="box box-info">
                    <div class="box-header with-border clearfix">
                        ...
                        <a target="_blank" href="{{ route('kerjasama.pendaftaran.kerjasama.template') }}" type="button"
                            class="btn btn-success pull-right"><i class="fa fa-download"></i> Unduh Dokumen
                            Kerjasama</a>
                    </div>
                    <form class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('status_registrasi') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control input-sm" type="text" wire:model="status_registrasi"
                                        readonly>
