    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data = $('#program-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: `{{ $settings['api_server_database_gabungan'] ?? '' }}{{ '/api/v1/opendk/bantuan-datatable?' .
                        http_build_query([
            ...
            async function downloadExcel() {
                try {
                    ...
                    const tableData = $('#program-table').DataTable();
                    ...
                    if (totalData === 0) {
                        Swal.fire({
                            ...
                            text: 'Tidak ada data program bantuan untuk diunduh. Silakan periksa filter Anda.',
                    ...
                    const downloadUrl = new URL(
                        `{{ $settings['api_server_database_gabungan'] }}/api/v1/opendk/bantuan/download`);
                    ...
                    let filename = 'data_program_bantuan.xlsx';
                    if (contentDisposition) {
                        ...
                        filename = `data_program_bantuan_${timestamp}.xlsx`;
                    }
