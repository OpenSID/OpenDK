...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {{ html()->text('nama')
        ->value(old('nama', isset($lembaga) ? $lembaga->nama : ''))
        ->class('form-control')
        ->required()
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {{ html()->text('kode')
        ->value(old('kode', isset($lembaga) ? $lembaga->kode : ''))
        ->class('form-control')
        ->required()
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div style="display: flex; flex-direction: column;">
            {{ html()->select('lembaga_kategori_id', $kategoriLembagaList)
            ->class('form-control select2')
            ->placeholder('Pilih Kategori Lembaga')
            ->value(old('lembaga_kategori_id', isset($lembaga) ? $lembaga->lembaga_kategori_id : ''))
            }}
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div style="display: flex; flex-direction: column;">
            {{ html()->select('penduduk_id', $pendudukList)
            ->class('form-control select2')
            ->placeholder('Pilih Ketua Lembaga')
            ->value(old('penduduk_id', isset($lembaga) ? $lembaga->penduduk_id : ''))
            }}
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ->value(old('keterangan', isset($lembaga) ? $lembaga->keterangan : ''))
        ->class('form-control')
