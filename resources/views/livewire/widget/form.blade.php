            ...
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <x-form-group name="widget.judul">
                        ...
                        <div class="col-sm-8">
                            <x-input type="text" placeholder="Judul Widget" wire:model.blur="widget.judul" />
                    ...
                    <x-form-group name="widget.jenis_widget">
                        ...
                        <div class="col-sm-8">
                            <x-tom-select wire:model.live="widget.jenis_widget">
                    ...
                    @if (isset($widget['jenis_widget']) && $widget['jenis_widget'] == 2)
                        <x-form-group name="widget.isi">
                            <x-label for="widget.isi">Nama File Widget (.php)</x-label>
                            <div class="col-sm-8">

                                @if ($list_widget)
                                    <x-tom-select wire:model.live="widget.isi">
                                ...
                                @else
                                    <span class="help-block"><code>Widget tidak tersedia atau sudah ditambahkan
                                            semua</code></span>
                                @endif
                    ...
                    @elseif(isset($widget['jenis_widget']) && $widget['jenis_widget'] == 3)
                        <x-form-group name="widget.isi">
                            <x-label for="'widget.isi">Isi</x-label>
                            <div class="col-sm-8">
                                <x-textarea wire:model.blur="widget.isi" />
