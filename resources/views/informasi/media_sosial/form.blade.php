...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <img class="hide" src="@if(isset($medsos->logo)) {{ asset($medsos->logo) }} @else {{ "http://placehold.it/1000x600" }} @endif"  id="showgambar" style="max-width:400px;max-height:250px;float:left;"/>
