<div class="form-group">
    ...
    <div class="col-md-2 col-sm-6 col-xs-12">
        {!! Html::number('tidak_tamat_sekolah', null, ['class' => 'form-control', 'required' => true, 'id' =>
        'tidak_tamat_sekolah']) !!}
    </div>
</div>
...
<div class="form-group">
    <label for="tamat_sd" class="control-label col-md-4 col-sm-3 col-xs-12">Tamat SD <span
            class="required">*</span></label>
    <div class="col-md-2 col-sm-6 col-xs-12">
        {!! Html::number('tamat_sd', null, ['class' => 'form-control', 'required' => true, 'id' => 'tamat_sd']) !!}
    </div>
</div>
...
<div class="form-group">
    <label for="tamat_smp" class="control-label col-md-4 col-sm-3 col-xs-12">Tamat SMP <span
            class="required">*</span></label>
    <div class="col-md-2 col-sm-6 col-xs-12">
        {!! Html::number('tamat_smp', null, ['class' => 'form-control', 'required' => true, 'id' => 'tamat_smp']) !!}
    </div>
</div>
...
<div class="form-group">
    <label for="tamat_sma" class="control-label col-md-4 col-sm-3 col-xs-12">Tamat SMA <span
            class="required">*</span></label>
    <div class="col-md-2 col-sm-6 col-xs-12">
        {!! Html::number('tamat_sma', null, ['class' => 'form-control', 'required' => true, 'id' => 'tamat_sma']) !!}
    </div>
</div>
...
<div class="form-group">
    <label for="tamat_diploma_sederajat" class="control-label col-md-4 col-sm-3 col-xs-12">Tamat Diploma/Sederajat <span
            class="required">*</span></label>
    <div class="col-md-2 col-sm-6 col-xs-12">
        {!! Html::number('tamat_diploma_sederajat', null, ['class' => 'form-control', 'required' => true, 'id' =>
