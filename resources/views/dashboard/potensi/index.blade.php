        ...
        <div class="col-md-8">
            <div class="box box-widget">
                ...
                <div class="box-body">
                    ...
                    <div class="attachment-block clearfix">
                        ...
                        <div class="attachment-text">
                            ...
                            <div class="pull-right button-group" style="position:relative; bottom:0px; margin-bottom: 0px;">
                                <a href="{{ route('potensi.kategori.show',  ['kategori'=> $kategoriPotensi->slug, 'slug'=> str_slug($potensi->nama_potensi)]) }}" class="btn btn-xs btn-info"><i class="fa fa-angle-double-down"></i> Read More</a>
                            </div>
                        </div>
                        <!-- /.attachment-text -->
                        </div>
                    ...
                    @else
                        <h2>Data {{ $kategoriPotensi->nama_kategori }} Belum Tersedia</h2>
                    @endif
                    <!-- /.box-body -->
                </div>
