...
<header class="main-header">
    ...
    <a href="{{$app->make('url')->to('/')}}" class="logo">
        ...
        <span class="logo-mini"><img src="@if(isset($profil_wilayah->file_logo)) {{  asset($profil_wilayah->file_logo) }} @else {{   asset('img/logo_nav.png')}}@endif" alt="KD"  width="42px"></span>
        <!-- logo for regular state and mobile devices -->
        <div class="logo-lg" style="justify-content: flex-start; height: 100%; width:100%; display: flex;">
            <div><img class="user-image" src="@if(isset($profil_wilayah->file_logo)) {{  asset($profil_wilayah->file_logo) }} @else {{   asset('img/logo_nav.png')}}@endif" style="padding-right:5px; max-width:42px" alt="KD" width="42px"></div>
