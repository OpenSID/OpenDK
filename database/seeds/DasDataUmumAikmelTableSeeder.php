    ...
    public function run()
    {
        ...
        \DB::table('das_data_umum')->insert(array (
            ...
            array (
                ...
                'tipologi' => 'Kecamatan Berkembang',
                'luas_wilayah' => 0.0,
                'jumlah_penduduk' => 0,
                'jml_laki_laki' => 0,
                'jml_perempuan' => 0,
                'bts_wil_utara' => 'Kecamatan Harau',
                'bts_wil_timur' => 'Kecamatan Lareh Sago Halaban',
                'bts_wil_selatan' => 'Kecamatan Situjuah Limo Nagari',
                'bts_wil_barat' => 'Kota Payakumbuh',
                'jml_puskesmas' => 0,
