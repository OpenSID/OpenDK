    ...
    public function getDataAnggaran()
    {
        return DataTables::of(AnggaranRealisasi::all())
            ->addColumn('aksi', function ($row) {
                $data['edit_url'] = auth()->user()->can('access.data.anggaran_realisasi.edit') ? route('data.anggaran-realisasi.edit', $row->id) : null;
                $data['delete_url'] = auth()->user()->can('access.data.anggaran_realisasi.delete') ? route('data.anggaran-realisasi.destroy', $row->id) : null;
