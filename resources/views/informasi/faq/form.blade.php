<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {{ html()->text('question')->value(old('question', $faq->question ?? ''))->placeholder('Pertanyaan')->class('form-control')->required() }}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {{ html()->select('status', ['1' => 'Aktif', '0' => 'Tidak Aktif'])->value(old('status', $faq->status ?? '1'))->class('form-control') }}
    </div>
</div>
