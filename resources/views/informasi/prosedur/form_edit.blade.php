...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <img class=""
            src="@if (isset($prosedur->file_prosedur)) {{ asset($prosedur->file_prosedur) }} @else {{ 'http://placehold.co/1000x600' }} @endif"
            id="showgambar" style="width:400px;max-height:250px;float:left;" />
        @endif

        @if (isset($prosedur->file_prosedur) && $prosedur->mime_type == 'pdf')
        <object data="@if (isset($prosedur->file_prosedur)) {{ asset($prosedur->file_prosedur . '#toolbar=1') }} @endif"
        ...
        <object data="@if (isset($prosedur->file_prosedur)) {{ asset($prosedur->file_prosedur) }} @endif"
            type="application/pdf" class="showpdf hide" id="showpdf"> </object>
