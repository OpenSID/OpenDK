<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <img src="@if(! $pegawai->foto == '') {{ asset('storage/pegawai/foto/'.$pegawai->foto) }} @else {{ "http://placehold.it/120x150" }} @endif" id="showgambar"
        ...
        <div class="form-group">
            <label for="nomor_ktp" class="control-label col-md-4 col-sm-3 col-xs-12">NIK<span class="required">*</span></label>

            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::text('nomor_ktp', null,['placeholder'=>'Nomor Induk Kependudukan', 'class'=>'form-control', 'required', 'id'=>'nomor_ktp']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary btn-sm @if($pegawai->jenis_kelamin == 1) active @endif">
                        <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="1" autocomplete="off" @if($pegawai->jenis_kelamin == 1) checked @endif> Laki-Laki
                    </label>
                    <label class="btn btn-primary btn-sm @if($pegawai->jenis_kelamin == 2) active @endif">
                        <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="2" autocomplete="off" @if($pegawai->jenis_kelamin == 2) checked @endif> Perempuan
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label for="pendidikan" class="control-label col-md-4 col-sm-3 col-xs-12">Pedidikan Terakhir</label>
    
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Form::select('pendidikan', ['S-3','S-2','S-1','D-4','D-3','D-2','D-1','SLTA','SMP'], null,['placeholder'=>'Pilih Pendidikan Terakhir', 'class'=>'form-control', 'id'=>'telepon']) !!}
            </div>
        </div>
    
        <div class="form-group">
            <label for="tamat_pendidikan" class="control-label col-md-4 col-sm-3 col-xs-12">Tamat Pendidikan </label>
        ...
        <div class="form-group">
            <label for="tmt_cpns" class="control-label col-md-4 col-sm-3 col-xs-12">TMT CPNS<span class="required">*</span></label>
        ...
        <div class="form-group">
            <label for="tmt_cpns" class="control-label col-md-4 col-sm-3 col-xs-12">TMT PANGKAT<span class="required">*</span></label>
        ...
        <div class="form-group">
            <label for="tmt_cpns" class="control-label col-md-4 col-sm-3 col-xs-12">TMT JABATAN<span class="required">*</span></label>
        ...
        <div class="form-group">
            ...
            <div class="input-group col-md-6 col-sm-6 col-xs-12">
                ...
                &nbsp;
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-primary btn-sm @if($pegawai->status == 1) active @endif">
                        <input type="radio" name="status" id="status" value="1" autocomplete="off" @if($pegawai->status == 1) checked @endif> Aktif
                    </label>
                    <label class="btn btn-primary btn-sm @if($pegawai->status == 2) active @endif">
                        <input type="radio" name="status" id="status" value="2" autocomplete="off" @if($pegawai->status == 2) checked @endif> Tidak Aktif
                    </label>
                </div>
            </div>
        </div>
