                ...
                <form action="{{ route('2fa.save-settings') }}" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('channel') ? 'has-error' : '' }}">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="channel" value="email" {{ (old('channel',
                                        $user->otp_channel) == 'email' || !old('channel') && !$user->otp_channel) ?
                                    'checked' : '' }} required>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="channel" value="telegram" {{ old('channel',
                                        $user->otp_channel) == 'telegram' ? 'checked' : '' }}>
