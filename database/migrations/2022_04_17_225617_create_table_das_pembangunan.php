...
class CreateTableDasPembangunan extends Migration
{
    ...
    public function up()
    {
        Schema::create('das_pembangunan', function (Blueprint $table) {
            ...
            $table->float('anggaran', 2)->nullable();
            $table->float('perubahan_anggaran', 2)->nullable();
            $table->float('sumber_biaya_pemerintah', 2)->nullable();
            $table->float('sumber_biaya_provinsi', 2)->nullable();
            $table->float('sumber_biaya_kab_kota', 2)->nullable();
            $table->float('sumber_biaya_swadaya', 2)->nullable();
            $table->float('sumber_biaya_jumlah', 2)->nullable();
