...
class ExportLaporanApbdes implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    ...
    /**
     * Ambil koleksi data laporan APBDes.
     *
    ...
    public function map($row): array
    {
        return [
            ...
            $row->semester,
            $row->nama_file,
            $row->imported_at ? date('Y-m-d H:i:s', strtotime($row->imported_at)) : '',
