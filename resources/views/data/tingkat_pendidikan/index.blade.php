    ...
    <section class="content container-fluid">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                @include('forms.btn-social', ['import_url' => auth()->user()->can('access.data.tingkat_pendidikan.import') ? route('data.tingkat-pendidikan.import') : null])
                @include('forms.btn-social', ['export_url' => auth()->user()->can('access.data.tingkat_pendidikan.export') ? route('data.tingkat-pendidikan.export-excel') : null])
            </div>
            <div class="box-body">
