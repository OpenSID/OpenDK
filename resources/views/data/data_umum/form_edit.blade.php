<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="control-label col-md-4 col-sm-3 col-xs-12">Data Luas Wilayah <span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <div class="col-md-7">
                        {{ Form::select('sumber_luas_wilayah',['1'=>'Manual',2=>'Dari Luas Desa'],null, ['class'=>'form-control sumber_luas_wilayah']) }}
                    </div>
                    <div class="col-md-5">
                        {!! Form::number('luas_wilayah', $luas_wilayah ,['placeholder'=>'0', 'class'=>'form-control luas_wilayah', 'required', 'style'=>'text-align:right;']) !!}
                    </div>
                </div>
            </div>
        </div>
