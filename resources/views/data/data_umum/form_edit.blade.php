<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::text('kecamatan', $data_umum->profil->nama_kecamatan, ['class' => 'form-control', 'disabled'
                => true]) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('tipologi', null, ['placeholder' => 'Tipologi', 'class' => 'form-control my-editor',
                'rows' => 2]) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('sejarah', null, ['placeholder' => 'Sejarah', 'class' => 'form-control my-editor',
                'rows' => 2]) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('ketinggian', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <div class="col-md-5">
                        {{ Html::select('sumber_luas_wilayah', ['1' => 'Manual', 2 => 'Dari Luas Desa'],
                        isset($data_umum->sumber_luas_wilayah) ? $data_umum->sumber_luas_wilayah : null, ['class' =>
                        'form-control sumber_luas_wilayah']) }}
                    </div>
                    <div class="col-md-7">
                        {!! Html::number('luas_wilayah', $luas_wilayah, [
                        'placeholder' => '0',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('bts_wil_utara', null, ['placeholder' => 'Batas Utara', 'class' => 'form-control',
                'required', 'rows' => 2]) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('bts_wil_timur', null, ['placeholder' => 'Batas Timur', 'class' => 'form-control',
                'required', 'rows' => 2]) !!}
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('bts_wil_selatan', null, ['placeholder' => 'Batas Selatan', 'class' =>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::textarea('bts_wil_barat', null, ['placeholder' => 'Batas Barat', 'class' => 'form-control',
                'required', 'rows' => 2]) !!}
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_puskesmas', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_puskesmas_pembantu', null, ['placeholder' => '0', 'class' => 'form-control',
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_posyandu', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_pondok_bersalin', null, ['placeholder' => '0', 'class' => 'form-control',
                'required', 'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_paud', null, ['placeholder' => '0', 'class' => 'form-control', 'required', 'style'
                => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_sd', null, ['placeholder' => '0', 'class' => 'form-control', 'required', 'style'
                => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_smp', null, ['placeholder' => '0', 'class' => 'form-control', 'required', 'style'
                => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_sma', null, ['placeholder' => '0', 'class' => 'form-control', 'required', 'style'
                => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_masjid_besar', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_mushola', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_gereja', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_pasar', null, ['placeholder' => '0', 'class' => 'form-control', 'required',
                'style' => 'text-align:right;']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                {!! Html::number('jml_balai_pertemuan', null, ['placeholder' => '0', 'class' => 'form-control',
                'required', 'style' => 'text-align:right;']) !!}
            </div>
        </div>
    </div>
