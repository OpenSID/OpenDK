            ...
            <div class="col-md-5">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        {!! html()->button()->type('button')->class('btn btn-primary btn-sm')->id('btnUpdate')->html('<i class="fa fa-save"></i> Simpan') !!}
                        {!! html()->button()->type('button')->class('btn btn-success btn-sm')->id('btnAdd')->html('<i class="fa fa-plus-square"></i> Tambah') !!}
                    </div>
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-footer">
                                {!! html()->button()->type('button')->class('btn btn-danger btn-sm')->html('<i class="fa fa-times"></i> Batal') !!}

                                {!! html()->button()->type('submit')->class('btn btn-primary btn-sm')->html('<i class="fa fa-save"></i> Simpan') !!}
                            </div>
                        </div>
                    </div>
                </div>
