        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (isset($user))
                        ...
                        <ul class="treeview-menu">
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['informasi/prosedur*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('informasi.prosedur.index') }}"><i
                                            class="fa fa-circle-o"></i>Prosedur</a>
                                </li>
                            @endrole
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['informasi/regulasi*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('informasi.regulasi.index') }}"><i
                                            class="fa fa-circle-o"></i>Regulasi</a>
                                </li>
                            @endrole
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['informasi/potensi*']) ? 'class=active' : '' }}><a
                                        href="{{ route('informasi.potensi.index') }}"><i
                                            class="fa fa-circle-o"></i>Potensi</a></li>
                            @endrole
                            @role('super-admin|admin-kecamatan|administrator-website')
                            ...
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['informasi/media-sosial*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('informasi.media-sosial.index') }}"><i
                                            class="fa fa-circle-o"></i>Media Sosial</a>
                                </li>
                            @endrole
                            @role('super-admin|admin-kecamatan|administrator-website')
                            ...
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['informasi/sinergi-program*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('informasi.sinergi-program.index') }}"><i
                                            class="fa fa-circle-o"></i>Sinergi Program</a>
                                </li>
                            @endrole
                        </ul>
                    </li>
                            ...
                            @role('super-admin|admin-kecamatan|administrator-website')
                                <li {{ Request::is(['kerjasama/pendaftaran-kerjasama*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('kerjasama.pendaftaran.kerjasama') }}"><i
                                            class="fa fa-circle-o"></i>Pendaftaran Kerjasama</a>
                                </li>
                            @endrole
                        </ul>
                    </li>
                        ...
                        <ul class="treeview-menu">
                                ...
                                <li
                                    ...
                                    <ul class="treeview-menu">
                                        <li {{ Request::is(['data/profil*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.profil.index') }}"><i
                                                    class="fa fa-circle-o"></i>Profil</a>
                                        </li>
                                        <li {{ Request::is(['data/data-umum*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.data-umum.index') }}"><i
                                                    class="fa fa-circle-o"></i>Data Umum</a>
                                        </li>
                                        <li {{ Request::is(['data/data-desa*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.data-desa.index') }}"><i
                                ...
                                <li
                                    ...
                                    <ul class="treeview-menu">
                                        <li {{ Request::is(['data/penduduk*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.penduduk.index') }}"><i
                                                    class="fa fa-circle-o"></i>Penduduk</a>
                                        </li>
                                        <li {{ Request::is(['data/keluarga*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.keluarga.index') }}"><i
                                                    class="fa fa-circle-o"></i>Keluarga</a>
                                        </li>
                                        <li {{ Request::is(['data/data-suplemen*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.data-suplemen.index') }}"><i
                                                    class="fa fa-circle-o"></i>Data Suplemen</a>
                                        </li>
                                        <li {{ Request::is(['data/laporan-penduduk*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.laporan-penduduk.index') }}"><i
                                                    class="fa fa-circle-o"></i>Laporan Penduduk</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li
                                    ...
                                    <ul class="treeview-menu">
                                        <li {{ Request::is(['data/aki-akb*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.aki-akb.index') }}"><i
                                                    class="fa fa-circle-o"></i>AKI & AKB</a>
                                        </li>
                                        <li {{ Request::is(['data/imunisasi*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.imunisasi.index') }}"><i
                                                    class="fa fa-circle-o"></i>Imunisasi</a>
                                        </li>
                                        <li {{ Request::is(['data/epidemi-penyakit*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.epidemi-penyakit.index') }}"><i
                                                    class="fa fa-circle-o"></i>Epidemi Penyakit</a>
                                        </li>
                                        <li {{ Request::is(['data/toilet-sanitasi*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.toilet-sanitasi.index') }}"><i
                                                    class="fa fa-circle-o"></i>Toilet & Sanitasi</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li
                                    ...
                                    <ul class="treeview-menu">
                                        <li {{ Request::is(['data/tingkat-pendidikan*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.tingkat-pendidikan.index') }}"><i
                                                    class="fa fa-circle-o"></i>Tingkat Pendidikan</a>
                                        </li>
                                        <li {{ Request::is(['data/putus-sekolah*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.putus-sekolah.index') }}"><i
                                                    class="fa fa-circle-o"></i>Siswa Putus Sekolah</a>
                                        </li>
                                        <li {{ Request::is(['data/fasilitas-paud*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.fasilitas-paud.index') }}"><i
                                                    class="fa fa-circle-o"></i>Fasilitas PAUD</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            ...
                            @if ($user->hasrole(['super-admin', 'administrator-website', 'admin-desa']))
                                <li {{ Request::is(['data/program-bantuan*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('data.program-bantuan.index') }}"><i
                                            class="fa fa-circle-o"></i>Program Bantuan</a>
                                </li>
                            @endif
                                    ...
                                    <ul class="treeview-menu">
                                        @if ($user->hasrole(['super-admin', 'admin-kecamatan', 'administrator-website']))
                                            <li {{ Request::is(['data/anggaran-realisasi*']) ? 'class=active' : '' }}>
                                                <a href="{{ route('data.anggaran-realisasi.index') }}"><i
                                                        class="fa fa-circle-o"></i>Anggaran & Realisasi</a>
                                            </li>
                                        @endif

                                        @if ($user->hasrole(['super-admin', 'admin-desa', 'administrator-website']))
                                            <li {{ Request::is(['data/anggaran-desa*']) ? 'class=active' : '' }}>
                                                <a href="{{ route('data.anggaran-desa.index') }}"><i
                                                        class="fa fa-circle-o"></i>APBDes</a>
                                            </li>
                                        @endif

                                        @if ($user->hasrole(['super-admin', 'admin-desa', 'administrator-website']))
                                            <li {{ Request::is(['data/laporan-apbdes*']) ? 'class=active' : '' }}>
                                                <a href="{{ route('data.laporan-apbdes.index') }}"><i
                                                        class="fa fa-circle-o"></i>Laporan APBDes</a>
                                            </li>
                                        @endif
                                    </ul>
                                </li>
                            ...
                            @if ($user->hasrole(['super-admin', 'admin-desa', 'admin-kecamatan', 'administrator-website']))
                                <li {{ Request::is(['data/pembangunan*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('data.pembangunan.index') }}"><i
                                            class="fa fa-circle-o"></i>Pembangunan</a>
                                </li>
                            @endif
                            ...
                            @if ($user->hasrole(['super-admin', 'admin-desa', 'admin-kecamatan', 'administrator-website']))
                                <li
                                    class="treeview {{ Request::is(['data/kategori-lembaga*', 'data/lembaga*']) ? 'active' : '' }}">
                                    ...
                                    <ul class="treeview-menu">
                                        <li {{ Request::is(['data/lembaga*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.lembaga.index') }}"><i
                                                    class="fa fa-circle-o"></i>Lembaga</a>
                                        </li>
                                        <li {{ Request::is(['data/kategori-lembaga*']) ? 'class=active' : '' }}>
                                            <a href="{{ route('data.kategori-lembaga.index') }}"><i
                                                    class="fa fa-circle-o"></i>Kategori Lembaga</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                        ...
                        <ul class="treeview-menu">
                            ...
                            @role('super-admin|admin-komplain|administrator-website')
                                <li {{ Request::is(['admin-komplain/statistik*']) ? 'class=active' : '' }}><a
                                        href="{{ route('admin-komplain.statistik') }}"><i
                    ...
                    <li class="treeview {{ Request::is(['surat*']) ? 'active' : '' }}">
                        ...
                        <ul class="treeview-menu">
                            <li {{ Request::is(['surat/permohonan*']) ? 'class=active' : '' }}><a
                                    href="{{ route('surat.permohonan') }}"><i
                                        class="fa fa-files-o"></i>Permohonan</a></li>
                ...
                @if ($user->hasrole(['super-admin', 'administrator-website']))
                    <li class="treeview {{ Request::is(['setting*']) ? 'active' : '' }}"><a href="#"><i
                                class="fa fa-cogs"></i> <span>Pengaturan</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li {{ Request::is(['setting.navmenu*']) ? 'class=active' : '' }}>
                                <a href="{{ route('setting.navmenu.index') }}"><i
                                        class="fa fa-circle-o"></i>Menu</a>
                            </li>
                            ...
                            <li {{ Request::is(['setting/tipe-potensi*']) ? 'class=active' : '' }}>
                                <a href="{{ route('setting.tipe-potensi.index') }}"><i
                                        class="fa fa-circle-o"></i>Kategori Potensi</a>
                            </li>
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/komplain-kategori*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('setting.komplain-kategori.index') }}"><i
                                            class="fa fa-circle-o"></i>Kategori
                                        Komplain</a>
                                </li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/tipe-regulasi*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('setting.tipe-regulasi.index') }}"><i
                                            class="fa fa-circle-o"></i>Tipe
                                        Regulasi</a>
                                </li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/jenis-penyakit*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('setting.jenis-penyakit.index') }}"><i
                                            class="fa fa-circle-o"></i>Jenis Penyakit</a>
                                </li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/jenis-dokumen*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('setting.jenis-dokumen.index') }}"><i
                                            class="fa fa-circle-o"></i>Jenis Dokumen</a>
                                </li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/slide*']) ? 'class=active' : '' }}>
                                    <a href="{{ route('setting.slide.index') }}"><i
                                            class="fa fa-circle-o"></i>Slide</a>
                                </li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                        ...
                        @endif --}}
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/themes*']) ? 'class=active' : '' }}><a
                                        href="{{ route('setting.themes.index') }}"><i
                            ...
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                                <li {{ Request::is(['setting/aplikasi*']) ? 'class=active' : '' }}><a
                                        href="{{ route('setting.aplikasi.index') }}"><i
                                            class="fa fa-circle-o"></i>Aplikasi</a></li>
                            @endif
                            @if ($user->hasrole(['super-admin', 'administrator-website']))
                            ...
                            <li
                                {{ Request::is(['setting/backup-database', 'setting/restore-database']) ? 'class=active' : '' }}>
