<x-action-dropdown>
    ...
    @endif
    @if (!empty($show_url))
        <li><a href="{!! $show_url !!}" title="Lihat" target="_blank" data-testid="btn-lihat"><i class="fa fa-eye text-warning"></i> Lihat</a></li>
    @endif
    @if (!empty($peta))
    ...
    @if (!empty($edit_url))
        <li><a href="{!! $edit_url !!}" title="Ubah" data-testid="btn-edit"><i class="fa fa-edit text-success"></i> Ubah</a></li>
    @endif
    @if (!empty($modal_form))
    ...
    @if (!empty($download_url))
        <li><a href="{!! $download_url !!}" title="Unduh" data-testid="btn-download"><i class="fa fa-download text-info"></i> Unduh</a></li>
    @endif
    ...
    @if (!empty($lock_url))
        <li><a href="javascript:void(0)" data-href="{!! $lock_url !!}" id="lockModal" title="Tidak Aktif" data-testid="btn-lock"><i class="fa fa-lock text-muted"></i> Nonaktifkan</a></li>
    @endif
    @if (!empty($unlock_url))
        <li><a href="javascript:void(0)" data-href="{!! $unlock_url !!}" id="unlockModal" title="Aktif" data-testid="btn-unlock"><i class="fa fa-unlock text-success"></i> Aktifkan</a></li>
    @endif
    @if (!empty($active_url))
    ...
    @if (!empty($delete_url))
        <li class="divider"></li>
        <li><a href="javascript:void(0)" data-href="{!! $delete_url !!}" id="deleteModal" title="Hapus" style="color: #dd4b39;" data-testid="btn-hapus"><i class="fa fa-trash text-danger"></i> Hapus</a></li>
    @endif
</x-action-dropdown>
