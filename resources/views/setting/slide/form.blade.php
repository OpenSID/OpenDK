...
<div class="form-group">
    <label for="nama" class="control-label col-md-4 col-sm-3 col-xs-12">Deskripsi<span
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input accept="jpg,jpeg,png" type="file" name="gambar" id="gambar" class="form-control"
            {{ $slide ? '' : 'required' }}>
