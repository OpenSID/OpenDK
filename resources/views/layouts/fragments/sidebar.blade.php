        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (isset($user))
                ...
                @can('access.kerjasama')
                    <li class="treeview {{ Request::is(['keriesa/*']) ? 'active' : '' }}">
                        <a href="#"><i class="fa fa-handshake-o"></i> <span>Keriesa</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li {{ Request::is(['keriesa/pendaftaran-keriesa*']) ? 'class=active' : '' }}>
                                <a href="#"><i class="fa fa-circle-o"></i>Pendaftaran Keriesa</a>
                            </li>
                        </ul>
                    </li>
                @endcan
