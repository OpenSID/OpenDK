<a href="{{ route('sistem-komplain.kirim') }}" class="btn btn-warning btn-block margin-bottom"><b><i class="fa fa-paper-plane"></i> Kirim Keluhan</b></a>
    ...
    <div class="box-body flat box-profile">
        <form class="form-horizontal" method="post" action="{{ route('sistem-komplain.tracking') }}">
            <div class="input-group input-group-sm">
                {{ csrf_field() }}
                <input class="form-control" required type="text" id="tracking" name="komplain_id" placeholder="Tracking ID Keluhan Anda" />
