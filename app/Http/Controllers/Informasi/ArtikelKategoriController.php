        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('aksi', function ($row) {
                    if (!auth()->guest()) {
                        $data['edit_url'] = auth()->user()->can('access.informasi.artikel_kategori.edit') ? route('informasi.artikel-kategori.edit', $row->id_kategori) : null;
                        $data['delete_url'] = auth()->user()->can('access.informasi.artikel_kategori.delete') ? route('informasi.artikel-kategori.destroy', $row->id_kategori) : null;
                    }
