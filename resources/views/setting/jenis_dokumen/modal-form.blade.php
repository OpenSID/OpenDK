<div class="modal fade" id="modal-form">
    <div class="modal-dialog">
        <form action="{{ route('setting.jenis-dokumen.store') }}" method="post">
            @csrf
    ...
    <script>
        $(function() {
            $('#modal-form').on('click', 'button[type="submit"]', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        form[0].reset();
                        $('#data_jenis_dokumen').DataTable().ajax.reload();
            ...
            $(document).on('click', '.open_form', function() {
                ...
                const routeEdit = '{{ route('setting.jenis-dokumen.edit', ':id') }}'.replace(':id', id);
                const routeUpdate = '{{ route('setting.jenis-dokumen.update', ':id') }}'.replace(':id', id);
                ...
                $.get(routeEdit)
                    .done(data => {
                        ...
                        $('#modal-form .modal-title').text('Ubah Jenis Dokumen');
