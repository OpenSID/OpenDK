            ...
            <div class="box box-primary">
                ...
                @if (count($errors) > 0)
                    ...
                    @endif
                            ...
                            <!-- form start -->
                    {!!  Form::model($akta, [ 'route' => ['data.proses-aktalahir.update', $akta->id], 'method' => 'put','id' => 'form-akta', 'class' => 'form-horizontal form-label-left'] ) !!}

                    <div class="box-body">

                        @include('data.proses_aktalahir.form_edit')
