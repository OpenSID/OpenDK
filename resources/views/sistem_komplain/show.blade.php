                            ...
                            <div class="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p>Yth:
                                            {{ config('profil.sebutan_kepala_wilayah') . ' ' .
                                            config('profil.nama_kecamatan') }}
                                        </p>
                                        <br>
                                        <p>
                                            {{ $komplain->laporan }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @if ($komplain->lampiran1 == '' && $komplain->lampiran2 == '' &&
                                        $komplain->lampiran3 == '' && $komplain->lampiran4 == '')
                                        <p>
                                            Tidak ada lampiran.
                                        </p>
                                        @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="pull-right">
                                <div class="control-group">
                                    ...
                                    @if (isset($user) && $user->hasRole(['super-admin', 'admin-kecamatan',
                                    'admin-komplain']))
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <label>Jawaban</label>
                    {{ Html::textarea('jawaban', null, ['class' => 'form-control', 'id' => 'jawab-admin', 'required'])
                    }}
                    {{ Html::hidden('nik', '999') }}
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                    <label>Jawaban</label>
                    {{ Html::textarea('jawaban', null, ['class' => 'form-control', 'id' => 'ubah-jawab-admin',
                    'required']) }}
                    {{ Html::hidden('nik', '999') }}
                    {{ Html::hidden('id', null, ['id' => 'id_jawab']) }}
