    ...
    <div class="col-md-5 col-sm-5 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6 pr-md-1">
                ...
                \App\Enums\TipeWaktuFormDokumen::Hari)->value(old('tipe_waktu', isset($dokumen)->value(old('tipe_waktu',
                isset($dokumen) ? $dokumen->tipe_waktu : '')) ? $dokumen->tipe_waktu :
...
<div class="form-group">
    ...
    <div class="col-md-5 col-sm-5 col-xs-12">
        ...
        \App\Enums\StatusFormDokumen::Terbit)->value(old('status', isset($dokumen)->value(old('status', isset($dokumen)
        ? $dokumen->status : '')) ? $dokumen->status : '')))->class('form-control')->placeholder('- Pilih -') !!}
    </div>
</div>
