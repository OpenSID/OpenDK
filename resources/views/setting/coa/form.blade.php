<div class="form-group">
    <label for="type_id" class="control-label col-md-3 col-sm-6 col-xs-12">Tipe Akun <span
...
<div class="form-group">
    <label for="sub_id" class="control-label col-md-3 col-sm-6 col-xs-12">Sub Akun <span
            class="required">*</span></label>
...
<div class="form-group">
    <label for="sub_sub_id" class="control-label col-md-3 col-sm-6 col-xs-12">Sub Sub Akun <span
            class="required">*</span></label>
...
<div class="form-group">
    <label for="coa_name" class="control-label col-md-3 col-sm-6 col-xs-12">Nama Akun <span
            class="required">*</span></label>
...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            $('#type_id').on('change', function(e) {
                ...
                $.ajax('{!! url('setting/coa/sub_coa/') !!}' + '/' + type_id, {}).done(function(data_sub) {
                    ...
                    $.ajax('{!! url('setting/coa/sub_sub_coa/') !!}' + '/' + type_id + '/' + data_sub[0].id, {}).done(function(data_sub_sub) {
            ...
            $('#sub_id').on('change', function(e) {
                ...
                $('#sub_sub_id option').remove();
                $.ajax('{!! url('setting/coa/sub_sub_coa/') !!}' + '/' + type_id + '/' + sub_id, {}).done(function(data) {
            ...
            function generate_id(type_id, sub_id, sub_sub_id) {
                ...
                $.ajax('{!! url('setting/coa/generate_id/') !!}' + '/' + type_id + '/' + sub_id + '/' + sub_sub_id, {}).done(function(data) {
                    $('#id').val(data);
                });
            }
            var type_id = $('#type_id').val();
