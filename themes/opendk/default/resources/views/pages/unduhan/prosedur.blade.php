            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.data && response.data.length > 0) {
                        ...
                        let objFile = !isPdf ? `<img id="fileUnduhan" src="${prosedur.file_prosedur_path}" width="100%">` : `<iframe src="${prosedur.file_prosedur_path}" width="100%" height="500" class="" id="showpdf" frameborder="0"></iframe>`;
