...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Mulai <span class="required">*</span></label>
...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Selesai <span class="required">*</span></label>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::textarea('description', null,['class'=>'textarea', 'placeholder'=>'Deskripsi kegiatan', 'style'=>'width: 100%;
