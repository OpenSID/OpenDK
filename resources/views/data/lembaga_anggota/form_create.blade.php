...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div style="display: flex; flex-direction: column;">
            {!! html()->select('penduduk_id', $pendudukList)->value(
                    old('penduduk_id', isset($anggota) ? $anggota->penduduk_id : (isset($lembaga) ? $lembaga->penduduk_id : '')),
                )->class(
                    'form-control
                                    select2',
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->number('no_anggota', old('no_anggota'))->placeholder(
                'Nomor Anggota',
            )->class('form-control')->required()->attribute('min', 1) !!}
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->text('no_sk_pengangkatan', old('no_sk_pengangkatan'))->placeholder(
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->text('no_sk_pemberhentian', old('no_sk_pemberhentian'))->placeholder(
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->date('tgl_sk_pemberhentian', old('tgl_sk_pemberhentian'))->placeholder(
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! html()->text('periode', old('periode'))->placeholder(
